...
| `./core` | `src/core` | Shared application state and services consumed by the UI: sessions and session-history projection, the chat-engine client protocol, agent presets and context, attachments, cron runs, runtime permissions, config, channels, wallpaper. |
