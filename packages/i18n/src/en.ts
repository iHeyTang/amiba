...
export const en = {
  ...
  "workspacePane.collaboration": "Agents",
  ...
  "workspacePane.outputs": "Outputs",
  "workspacePane.outputsHint": "Generated files and export-ready artifacts",
  "workspacePane.openWindow": "Open another window",
  "workspacePane.noOutputs": "No generated outputs yet",
  "workspacePane.project": "Project",
  "workspacePane.projects": "Projects",
  "workspacePane.switchProject": "Switch project",
  "workspacePane.worktreeCount": "{count} worktrees",
  "workspacePane.newProject": "New project from folder",
  "workspacePane.addFolder": "Add folder to project",
  "workspacePane.worktreeBranch": "New branch",
  "workspacePane.createWorktree": "Create worktree",
  ...
  "workspacePane.checkpoints": "Checkpoints",
  "workspacePane.checkpointName": "Checkpoint name",
  "workspacePane.saveCheckpoint": "Save",
  "workspacePane.restore": "Restore",
  "workspacePane.noCheckpoints": "No checkpoints yet",
  ...
  "options.nav.extensions": "Applets",
  ...
  "options.nav.section.extensions": "Applets",
  ...
  "options.extensions.managed.noSurface":
    "This Applet has no main view to display",
  ...
  "options.extensions.managed.search": "Search Applets, tags, or changes…",
  "options.extensions.managed.noSearchResults": "No matching Applets",
  ...
  "options.extensions.managed.serviceUnavailable":
    "The Applets service is temporarily unavailable. Restart Amiba and try again.",
  ...
  "options.extensions.managed.organizeDescription":
    "Collections and tags only help you find the Applet; they do not change what it does.",
  ...
  "options.extensions.managed.failed": "This Applet isn't usable yet.",
  ...
  "options.extensions.addLocal": "Add local Applet…",
  ...
  "options.extensions.uninstall.confirm.title": "Remove Applet?",
  ...
  "options.extensions.sideload.error": "Could not add local Applet: {error}",
  "options.extensions.actionFailed": "Applet action failed: {error}",
  "options.extensions.empty.title": "No Applets installed",
  "options.extensions.health.problem": "This Applet could not be loaded",
  "options.extensions.capabilities.title": "Features",
  "options.extensions.capability.main": "Main surface",
  ...
  "sidepanel.sessions.branch": "Branch from task",
  "sidepanel.sessions.export": "Export",
  "sidepanel.sessions.import": "Import",
