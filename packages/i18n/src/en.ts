...
export const en = {
  ...
  "options.extensions.managed.yoursDescription": "Everything you create or install lives here.",
  "options.extensions.managed.empty": "No Applets yet",
  "options.extensions.managed.emptyDescription": "Create one with AI, or install one locally or from the marketplace.",
  "options.extensions.managed.create.title": "Create an Applet",
  "options.extensions.managed.create.description": "Describe the problem to solve. AI and Amiba manage the implementation and versions.",
  "options.extensions.managed.create.name": "Name",
  "options.extensions.managed.create.namePlaceholder": "e.g. Weekly review helper",
  "options.extensions.managed.create.request": "What should it do?",
  "options.extensions.managed.create.requestPlaceholder": "Describe the use case, inputs, and the result you want to see…",
  ...
  "options.extensions.managed.improveDescription": "Say what feels wrong or what you want instead. The current working version stays available.",
  "options.extensions.managed.improvePlaceholder": "For example: clear the input after submit, and keep the buttons on one row on mobile…",
  ...
  "options.extensions.managed.noSurface": "This Applet has no main view to display",
  "options.extensions.managed.tools": "Available actions",
  "options.extensions.managed.formMode": "Form",
  "options.extensions.managed.noInputs": "This action does not require any input.",
  ...
  "options.extensions.managed.noSearchResultsDescription": "Try a different name, tag, or change description.",
  "options.extensions.managed.serviceUnavailable": "The Applets service is temporarily unavailable. Restart Amiba and try again.",
  ...
  "options.extensions.managed.deleteDescription": "It stops running and moves to Recently Deleted. Source, data, and recovery points are kept so you can restore it.",
  ...
  "options.extensions.managed.organizeDescription": "Collections and tags only help you find the Applet; they do not change what it does.",
  "options.extensions.managed.collection": "Collection",
  "options.extensions.managed.tags": "Tags",
  "options.extensions.managed.tagsPlaceholder": "Comma-separated, e.g. work, weekly",
  "options.extensions.managed.undo": "Undo the last change",
  "options.extensions.managed.failedSafe": "This update wasn't applied. The previous version still works.",
  "options.extensions.managed.failed": "This Applet isn't usable yet.",
  "options.extensions.managed.confirm.title": "This change needs your confirmation",
  "options.extensions.managed.confirm.description": "It adds permissions, providers, or a data-schema change. Preview it before applying.",
  "options.extensions.managed.keepCurrent": "Keep current version",
  "options.extensions.managed.developerDetails": "Developer and diagnostic details",
  ...
  "options.extensions.managed.status.needs-confirmation": "Waiting for confirmation",
