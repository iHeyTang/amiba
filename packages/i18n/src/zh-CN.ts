...
export const zhCN: Messages = {
  ...
  "workspacePane.collaboration": "智能体",
  ...
  "workspacePane.outputs": "产物",
  "workspacePane.outputsHint": "生成文件与可交付内容",
  "workspacePane.openWindow": "打开新窗口",
  "workspacePane.noOutputs": "还没有生成产物",
  "workspacePane.project": "项目",
  "workspacePane.projects": "项目",
  "workspacePane.switchProject": "切换项目",
  "workspacePane.worktreeCount": "{count} 个工作树",
  "workspacePane.newProject": "从文件夹新建项目",
  "workspacePane.addFolder": "向项目添加文件夹",
  "workspacePane.worktreeBranch": "新分支",
  "workspacePane.createWorktree": "创建工作树",
  ...
  "workspacePane.checkpoints": "检查点",
  "workspacePane.checkpointName": "检查点名称",
  "workspacePane.saveCheckpoint": "保存",
  "workspacePane.restore": "恢复",
  "workspacePane.noCheckpoints": "还没有检查点",
  ...
  "options.nav.section.extensions": "小应用",
  ...
  "options.extensions.title": "小应用",
  "options.extensions.managed.yours": "我的小应用",
  "options.extensions.managed.yoursDescription":
    "你创建和安装的小应用都在这里。",
  "options.extensions.managed.empty": "还没有小应用",
  "options.extensions.managed.emptyDescription":
    "可以让 AI 创建，也可以从本地或市场安装。",
  "options.extensions.managed.create.title": "创建小应用",
  "options.extensions.managed.create.description":
    "说清楚想解决的问题即可，技术实现和版本由 AI 与 Amiba 管理。",
  ...
  "options.extensions.managed.noSurface": "这个小应用没有可显示的主界面",
  ...
  "options.extensions.managed.search": "搜索小应用、标签或修改内容…",
  "options.extensions.managed.noSearchResults": "没有找到匹配的小应用",
  "options.extensions.managed.noSearchResultsDescription":
    "换一个名称、标签或修改内容试试。",
  "options.extensions.managed.serviceUnavailable":
    "小应用服务暂时不可用。重新启动 Amiba 后再试。",
  ...
  "options.extensions.managed.failed": "这个小应用暂时还不能使用。",
  ...
  "options.extensions.addLocal": "添加本地小应用…",
  ...
  "options.extensions.uninstall.confirm.title": "移除小应用？",
  ...
  "options.extensions.sideload.error": "添加本地小应用失败：{error}",
  "options.extensions.actionFailed": "小应用操作失败：{error}",
  "options.extensions.empty.title": "还没有安装小应用",
  "options.extensions.health.problem": "这个小应用无法加载",
  "options.extensions.capabilities.title": "功能",
  "options.extensions.capability.main": "主界面",
  ...
  "sidepanel.sessions.branch": "从此任务创建分支",
  "sidepanel.sessions.export": "导出",
  "sidepanel.sessions.import": "导入",
