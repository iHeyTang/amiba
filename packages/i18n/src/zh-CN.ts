...
export const zhCN: Messages = {
  ...
  "options.extensions.managed.yoursDescription": "你创建和安装的小应用都在这里。",
  "options.extensions.managed.empty": "还没有小应用",
  "options.extensions.managed.emptyDescription": "可以让 AI 创建，也可以从本地或市场安装。",
  "options.extensions.managed.create.title": "创建小应用",
  "options.extensions.managed.create.description": "说清楚想解决的问题即可，技术实现和版本由 AI 与 Amiba 管理。",
  ...
  "options.extensions.managed.create.requestPlaceholder": "描述使用场景、需要输入什么，以及希望看到怎样的结果……",
  ...
  "options.extensions.managed.improveDescription": "直接说哪里不好用，或希望它变成什么样。当前可用版本会继续保留。",
  "options.extensions.managed.improvePlaceholder": "例如：提交后没有清空输入框，而且手机上按钮会被挤到下一行……",
  ...
  "options.extensions.managed.noSearchResultsDescription": "换一个名称、标签或修改内容试试。",
  "options.extensions.managed.serviceUnavailable": "小应用服务暂时不可用。重新启动 Amiba 后再试。",
  ...
  "options.extensions.managed.deleteDescription": "它会停止运行并移到“最近删除”。源码、数据和恢复点仍会保留，你可以随时恢复。",
  ...
  "options.extensions.managed.organizeDescription": "合集和标签只用于帮你查找，不会改变小应用的功能。",
  ...
  "options.extensions.managed.failedSafe": "这次更新没有应用，原来的版本仍可正常使用。",
  "options.extensions.managed.failed": "这个小应用暂时还不能使用。",
  "options.extensions.managed.confirm.title": "这次修改需要你确认",
  "options.extensions.managed.confirm.description": "它新增了权限、Provider 或数据结构变化。你可以先查看新效果，再决定是否应用。",
