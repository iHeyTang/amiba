  ...
  return (
    ...
    >
      <div className="flex items-start gap-2">
        <span
          aria-hidden="true"
          data-slot="chat-error-icon"
          className="mt-1 shrink-0 text-[hsl(var(--warning))]"
        >
          <CircleAlert className="h-3 w-3" />
        </span>
        <div className="min-w-0 flex-1" data-slot="chat-error-content">
          ...
          <p className="whitespace-pre-wrap break-words text-[11px] leading-4 text-muted-foreground [overflow-wrap:anywhere]">
            {presentation.detail}
          </p>
          {error.hint && (
            <p className="mt-1 whitespace-pre-wrap break-words text-[11px] leading-4 text-muted-foreground/80 [overflow-wrap:anywhere]">
              {error.hint}
            </p>
          )}
          <button
