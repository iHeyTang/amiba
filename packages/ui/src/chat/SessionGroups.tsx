...
export function TopSection({
  ...
  const headerWrapCls = isRail
    ? "group/topsection relative flex w-full shrink-0 items-center rounded-md px-2 py-1 text-xs font-semibold text-muted-foreground transition-colors hover:bg-foreground/5 hover:text-foreground"
    : cn(
