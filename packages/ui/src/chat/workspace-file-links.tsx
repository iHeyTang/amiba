...
export function WorkspaceMarkdownLink({
  ...
  return (
    <>
      ...
      <button
        type="button"
        className="ml-0.5 inline-flex h-5 w-5 items-center justify-center rounded align-middle text-muted-foreground hover:bg-chat-surface-hover hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
