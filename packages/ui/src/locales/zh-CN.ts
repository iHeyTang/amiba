...
export const zhCN: UiMessages = {
  ...
  "sidepanel.trace.actions.askUser": "征询确认",
  "sidepanel.trace.ask.waiting": "等待回答…",
  "sidepanel.trace.ask.answered": "已回答 {answered}/{total}",
  "sidepanel.trace.ask.cancelled": "用户选择跳过",
  "sidepanel.trace.ask.skipped": "未回答",
