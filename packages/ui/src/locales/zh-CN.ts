...
export const zhCN: UiMessages = {
  ...
  "sidepanel.clarify.skip": "跳过本题",
  "sidepanel.clarify.skipHint": "这一题不作答，继续下一题",
  "sidepanel.clarify.submit": "提交",
  "sidepanel.clarify.dismiss": "暂不回答",
  "sidepanel.clarify.dismissHint": "先不回答这组问题，让 Agent 继续",
  "sidepanel.clarify.unanswered": "请选择一个选项或填写回答。",
  "sidepanel.clarify.incomplete": "请先完成这道问题。",
