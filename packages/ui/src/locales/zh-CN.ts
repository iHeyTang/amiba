...
export const zhCN: UiMessages = {
  ...
  "options.personal.update.offered": "发现新版本 {version}，下载安装包后手动安装。",
  "options.personal.update.downloading": "正在下载 {version} · {percent}%",
  "options.personal.update.downloadingTitle": "正在下载 {version}",
  "options.personal.update.downloaded": "版本 {version} 已就绪。重启即可安装，正在进行的任务将中断。",
  "options.personal.update.downloadedTitle": "版本 {version} 已就绪。",
  "options.personal.update.readyToInstall": "重启即可安装，正在进行的任务将中断。",
  "options.personal.update.ready": "版本 {version} 的安装包已下载完成。点击后 Amiba 将退出并打开安装窗口。",
  "options.personal.update.checkingDetail": "正在获取最新版本信息。",
  "options.personal.update.availableDetail": "将自动开始下载。",
  "options.personal.update.error": "更新失败，请检查网络后重试。",
  "options.personal.update.install": "重启并安装",
  "options.personal.update.download": "下载安装包",
  "options.personal.update.reveal": "打开安装包",
  "options.personal.update.cancel": "取消下载",
  "options.personal.update.cancelling": "正在取消…",
  ...
  "options.personal.update.downloadingHeading": "正在下载更新",
  "options.personal.update.manualInstallHint": "Amiba 将退出并打开安装窗口，请手动完成更新。",
  ...
  "sidepanel.tokens.outputTokens": "输出",
  "sidepanel.tokens.cacheWriteTokens": "缓存写入",
  "sidepanel.tokens.cacheReadTokens": "缓存命中",
  "sidepanel.tokens.unreported": "未上报",
