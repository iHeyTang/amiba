...
export const en = {
  ...
  "workspacePane.previewInBrowser": "Preview in browser",
  ...
  "workspacePane.newTab": "New tab",
  "workspacePane.chooseView": "Open a tool alongside this task.",
  "workspacePane.noExtensions": "No workbench extensions available.",
  ...
  "options.personal.update.idle": "You are up to date.",
  "options.personal.update.disabled": "Updates are unavailable in this build.",
  "options.personal.update.checking": "Checking for updates…",
  "options.personal.update.available": "Version {version} is available.",
  "options.personal.update.offered": "Version {version} is available. Download the installer to install it yourself.",
  "options.personal.update.downloading": "Downloading {version} · {percent}%",
  "options.personal.update.downloadingTitle": "Downloading {version}",
  "options.personal.update.downloaded": "Version {version} is ready. Restart to install; active work will be interrupted.",
  "options.personal.update.downloadedTitle": "Version {version} is ready.",
  "options.personal.update.readyToInstall": "Restart to install; active work will be interrupted.",
  "options.personal.update.ready": "Version {version} has downloaded. Amiba will quit and open the installer window.",
  "options.personal.update.checkingDetail": "Fetching the latest release information.",
  "options.personal.update.availableDetail": "The download will start automatically.",
  "options.personal.update.error": "Update failed. Check your connection and try again.",
  "options.personal.update.install": "Restart and install",
  "options.personal.update.download": "Download installer",
  "options.personal.update.reveal": "Open installer",
  "options.personal.update.cancel": "Cancel download",
  "options.personal.update.cancelling": "Cancelling…",
  ...
  "options.personal.update.downloadingHeading": "Downloading update",
  "options.personal.update.manualInstallHint": "Amiba will quit and open the installer. Complete the update in that window.",
  "options.personal.update.progress": "Update download progress",
  ...
  "sidepanel.trace.actionStatus.completed": "Completed · ",
  "sidepanel.trace.actionStatus.failed": "Failed · ",
  ...
  "sidepanel.tokens.details": "Turn token usage",
  "sidepanel.tokens.inputTokens": "Input (uncached)",
  "sidepanel.tokens.outputTokens": "Output",
  "sidepanel.tokens.cacheWriteTokens": "Cache write",
  "sidepanel.tokens.cacheReadTokens": "Cache hit",
  "sidepanel.tokens.unreported": "Not reported",
