...
export const en = {
  ...
  "sidepanel.trace.actions.askUser": "Ask the user",
  "sidepanel.trace.ask.waiting": "Waiting for answers…",
  "sidepanel.trace.ask.answered": "{answered}/{total} answered",
  "sidepanel.trace.ask.cancelled": "Dismissed by the user",
  "sidepanel.trace.ask.skipped": "Not answered",
