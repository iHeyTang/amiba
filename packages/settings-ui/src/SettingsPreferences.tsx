...
import { Label } from "@hermes-x/ui";
import { Switch } from "@hermes-x/ui";
...
function SummonHotkeyRow({
  ...
  const modeOptions: { value: SummonHotkey["kind"]; label: string }[] = [
    { value: "doubleTap", label: t("options.preference.hotkey.mode.doubleTap") },
    { value: "accelerator", label: t("options.preference.hotkey.mode.accelerator") },
  ...
  const modifierOptions: { value: SummonModifier; label: string }[] = [
    ...
    { value: "Control", label: t("options.preference.hotkey.modifier.Control") },
