...
export const en = {
  ...
  "shell.inspect.details": "Details",
  "shell.inspect.packageDetails": "Package and source",
  "shell.inspect.search": "Search names, descriptions or values",
  "shell.inspect.clear": "Clear",
  "shell.inspect.noMatches": "No matches",
  "shell.inspect.swipe": "Scroll horizontally to compare columns",
