...
import type { HtmlBodyProps } from './HtmlBody.js'
import { en } from './locales.js'
import { transferableAbortController } from 'node:util'
// This jsdom release lacks AbortSignal.any; use Node's real implementation.
...
describe('HtmlBody', () => {
  it('renders a Blob iframe with only scripts allowed, keeping it mounted for unrelated props', async () => {
    ...
    view.unmount()
    expect(revoke).toHaveBeenCalledTimes(1); expect(revoke).toHaveBeenCalledWith('blob:https://preview.invalid/1')
  })
