...
import type { PdfSession } from './document.js'
 ...
 */
export function openPdf(data: Uint8Array, signal: AbortSignal, reportFailure: (error: PdfWorkerFailure) => void): PdfSession {
