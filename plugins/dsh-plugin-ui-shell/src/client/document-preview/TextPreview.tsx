...
import { IconRefreshOutline16, Menu, Tooltip } from '@deepseek-ai/dsh-client-ui-primitives'
import { pathPartsOf } from './path-parts.js'
import type { TextInjected } from './face.js'
...
import type { DocumentContent } from './document/contract.js'
import { matchingDocumentPreviews } from './document/registry.js'
...
export type { LoadedPage } from './text/lines.js'
        ...
        {current?.failure !== undefined && (hasContent
          ...
          : (
            ...
            <div className={css.empty} data-textpreview-failed={current.failure.code}>
              <FileText size={36} className={css.emptyIcon} />
