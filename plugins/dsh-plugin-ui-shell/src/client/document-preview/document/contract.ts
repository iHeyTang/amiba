...
import type { UseSidebarRightTabInfo } from '../../sidebar-right/contract/slots.js'
...
/** Line navigation belongs to the file document type, including production builds. */
declare module '../../sidebar-right/contract/params.js' {
  interface SidebarRightResourceParamsMap { file: { readonly line?: number } }
}
