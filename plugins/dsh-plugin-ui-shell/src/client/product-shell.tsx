          ...
          >
            <FullScreenChatView
              ...
              slots={{
                ...
                assistantActions: (messageId) => renderSlot("conversation.chat.assistant-actions", { messageId: messageId as import("@deepseek-ai/dsh-client-ui-slots").SlotMap["conversation.chat.assistant-actions"]["owner"]["messageId"] }),
