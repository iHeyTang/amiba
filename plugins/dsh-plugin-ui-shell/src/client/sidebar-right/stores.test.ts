...
import type { LayoutState, PaneId, TabId } from './dockkit/index.js'
import { dockPaneIds, findTabPane, getPane, getSplit } from './dockkit/index.js'
...
describe('createSidebarRightStore — floating panels and dividers', () => {
  ...
  it('reports the pane a split created, and only then', () => {
    ...
    expect(settled).toHaveBeenCalledWith(created[0])
