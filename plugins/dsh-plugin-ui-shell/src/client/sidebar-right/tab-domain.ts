 ...
 */
import type { LayoutState, PaneId, TabId, TabRecord } from './dockkit/index.js'
import { findTabPane } from './dockkit/index.js'
import { createResourceSnapshotStore as createSnapshotStore, type ResourceSnapshotStore as SnapshotStore } from '../resources/snapshot-store.js'
import type { SessionId } from '@deepseek-ai/dsh-session/types'
import type { SidebarRightNavigationParams } from './contract/params.js'
import type { SidebarRightTabActions, SidebarRightTabNavigation, SidebarRightTabPlacement } from './contract/navigation.js'
import type { SidebarRightOpenResourceOptions, SidebarRightOpenTabOptions, SidebarRightPlacement } from './contract/navigation.js'
