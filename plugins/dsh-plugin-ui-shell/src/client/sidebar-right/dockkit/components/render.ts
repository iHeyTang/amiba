...
import type { DockLabels, TabMenuExtras, TabRenderer } from '../contract/adapter.js'
import type { PaneId, SplitId, TabId } from '../contract/types.js'
import type { DropTarget } from '../engine/geometry.js'
