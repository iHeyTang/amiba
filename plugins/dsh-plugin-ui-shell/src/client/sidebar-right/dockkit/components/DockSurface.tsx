...
import type { DockIntents, DockLabels, TabMenuExtras, TabRenderer } from '../contract/adapter.js'
import type { LayoutState, PaneId, SplitId, TabId } from '../contract/types.js'
...
import type { DropTarget, HalvesFit } from '../engine/geometry.js'
import {
...
import { PaneTree, type SizePreview } from './PaneTree.js'
import type { PaneCallbacks, SplitBlock } from './render.js'
