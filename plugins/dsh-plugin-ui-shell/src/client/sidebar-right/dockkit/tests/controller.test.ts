...
import { dockPaneCount, FLOAT_DEFAULT_SIZE } from '../engine/constraints.js'
import { SEED_CONTENT_ID, childAt, firstTab, seededController } from './fixtures.js'
import { dockPaneIds, findTabPane, getPane, getSplit } from '../engine/tree.js'
import type { LayoutState, PaneId } from '../contract/types.js'
