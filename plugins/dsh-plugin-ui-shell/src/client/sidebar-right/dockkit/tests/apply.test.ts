...
import { applyOp, replay } from '../engine/operations.js'
import { createIdMinter, createInitialState } from '../engine/initial.js'
import { asPane, asSplit, asTab, childAt, fileTab, firstTab, seedTab } from './fixtures.js'
import {
...
import type { IdMinter } from '../engine/initial.js'
import type { LayoutOp, LayoutState, PaneId, PaneNode, TabId } from '../contract/types.js'
