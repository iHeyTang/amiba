...
import type { LayoutState, TabId } from './dockkit/index.js'
import { DockController, getPane } from './dockkit/index.js'
import { TabDomain } from './tab-domain.js'
import type { SidebarRightNavigator } from './tab-domain.js'
...
declare module './contract/params.js' {
