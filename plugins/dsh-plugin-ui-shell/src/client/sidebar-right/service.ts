 ...
 */
import type { FloatRect, PaneId, TabId, TabRecord } from './dockkit/index.js'
import { activeDockPaneId, canSplit, dockPaneIds, findTabPane, getPane } from './dockkit/index.js'
import type { BoundActions } from '@deepseek-ai/dsh-client-ui-slots'
import type { SessionId } from '@deepseek-ai/dsh-session/types'
import type { SidebarRightNavigationParams, SidebarRightResourceParams, SidebarRightTabParamsFor } from './contract/params.js'
import { pageAddress } from './contract/seed.js'
import type { SidebarRightTabClaim, SidebarRightTabRegistry } from './tab-registry.js'
import type { SidebarRightState, SurfaceState } from './stores.js'
import type { createSidebarRightStore } from './stores.js'
import { TabDomain, type PinResource } from './tab-domain.js'
