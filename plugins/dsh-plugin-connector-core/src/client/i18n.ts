...
export const connectI18n: PluginCatalogOverlay = {
  en: {
    ...
    "options.connect.dsh.approval.label": "Approval wait",
    "options.connect.dsh.approval.timeout": "Reject after",
    "options.connect.dsh.approval.minutes": "minutes",
    "options.connect.dsh.approval.minutesLabel": "Minutes before rejecting",
    "options.connect.dsh.approval.wait": "Wait indefinitely",
  ...
  "zh-CN": {
    ...
    "options.connect.dsh.agentPreset": "Agent Preset",
    "options.connect.dsh.approval.label": "审批等待",
    "options.connect.dsh.approval.timeout": "超时拒绝，等待",
    "options.connect.dsh.approval.minutes": "分钟",
    "options.connect.dsh.approval.minutesLabel": "超时拒绝前等待的分钟数",
    "options.connect.dsh.approval.wait": "一直等",
