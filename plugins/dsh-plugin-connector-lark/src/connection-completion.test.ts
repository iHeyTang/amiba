...
import {LarkPersonalRemoteService} from "./index.js";
...
function fixture(){
 ...
 const manage=(action:string)=>LarkPersonalRemoteService.prototype.manage.call(service as any,{action,connectionId:"a"} as any);
