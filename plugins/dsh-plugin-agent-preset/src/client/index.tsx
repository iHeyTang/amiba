...
/**
 * Mount the 智能体预设 ("Agent presets") settings section.
 *
      ...
      ctx.slots.register(
        {
          ...
          id: SECTION_ID,
          // First plugin row of the Assistant group — directly after the
          // built-in 行为与人设 entry and before Models & services (50).
          order: 10,
          label: sectionLabel,
          inject: () => ({
            adapter,
