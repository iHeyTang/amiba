...
| 54 | `sidebar.right.pane.tab` | 入口已接入，桌面验证通过 | 已接入可选工作区面板，真实会话 store、tabInfo、重复导航、收起及类型卸载回退已通过桌面验证；官方 main 页面隔离、浮动/全屏及重挂载恢复已实测；实际会话切换、原生工作区隐藏、窄屏、完整第三方插件与 Web 仍待验证。 |
