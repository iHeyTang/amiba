...
const MODULES = [
  ...
  },
  {
    id: "mcp",
    enforced: false,
    todo: "T5: move McpToolsTab/DshMcpToolsTab into dsh-plugin-mcp-manager's client and remove the agentMcp adapter, then flip this module to enforced: true.",
    text: [
  ...
  },
  {
    id: "messaging",
    enforced: false,
    todo: "T6: move DshSettingsMessaging into dsh-plugin-messaging-core's client and remove the agentMessages adapter, then flip this module to enforced: true.",
    text: [
  ...
  },
  {
    id: "schedules",
    enforced: false,
    todo: "T7: move DshScheduledTasksPage/useScheduledRuns into dsh-plugin-schedule-adapter's client as an amiba.workspace.navigation/view contribution and remove the agentSchedules adapter, then flip this module to enforced: true.",
    text: [
  ...
  },
  {
    id: "usage",
    enforced: false,
    todo: "T8: move TokensPage/TokensTab/token-usage.ts into dsh-plugin-usage's client, drop the tokens SETTINGS_PAGES entry, and remove the agentUsage adapter, then flip this module to enforced: true.",
    text: [
