...
1. **Chrome** — `chrome://extensions/` → Developer mode → **Load unpacked** → the unzipped extension folder you downloaded from the [download page](https://iheytang.github.io/amiba-browser-extension/).
