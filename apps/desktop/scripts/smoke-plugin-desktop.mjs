...
try {
  ...
  if (process.argv.includes("--compat")) {
    ...
    if (process.argv.includes("--resident-draft")) {
      ...
      console.log("Standard inputActions edited the offscreen session document while the current editor stayed empty");
