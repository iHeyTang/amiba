...
try {
  ...
  if (process.argv.includes("--compat")) {
    ...
    console.log("Official unique-basename prose link passed actual live source mapping and file opening.");
