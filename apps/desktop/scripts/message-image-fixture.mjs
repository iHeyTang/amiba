    ...
    ctx.effect(()=>{
      const watcher=watch(${JSON.stringify(profile)},()=>{
        ...
        void (async()=>{
          ...
          imageSession.append('tool/code-dispatch',{parentCallId:'compat-nested-middle',subCallId:'compat-nested-image',name:'read_image',arguments:{file_path:'compat-nested-image.png'},content:[{type:'image',attachment:nestedAttachment}],isError:false});
